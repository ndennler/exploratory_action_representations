...
class RawAudioEncoder(nn.Module):
  ...
  def __init__(
    ...
    super(RawAudioEncoder, self).__init__()
    self.device = device
...
class RawAudioDecoder(nn.Module):
  ...
  def __init__(
    ...
    super(RawAudioDecoder, self).__init__()
    self.device = device
...
class RawAudioAE(nn.Module):
  ...
  def __init__(
    ...
    super(RawAudioAE, self).__init__()
    self.device = device

    self.encoder = RawAudioEncoder(input_dim, hidden_dim, latent_dim, device)
...
class Pretrained2RawAudioAE(nn.Module):
  ...
  def __init__(
    ...
    super(Pretrained2RawAudioAE, self).__init__()
    self.device = device

    self.encoder = RawAudioEncoder(output_dim, hidden_dim, latent_dim, device)

    self.decoder = RawAudioDecoder(self.encoder.get_intermediate_size(), self.encoder.get_reshape_size(), hidden_dim, latent_dim, device)
    self.encoder = PretrainedEncoder(input_dim, hidden_dim, latent_dim, device)
...
class Pretrained2RawAudioVAE(nn.Module):
  ...
  def __init__(
    ...
    super(Pretrained2RawAudioVAE, self).__init__()
    self.device = device
    self.nz = latent_dim

    self.encoder = RawAudioEncoder(output_dim, hidden_dim, 2*latent_dim, device)
    self.decoder = RawAudioDecoder(self.encoder.get_intermediate_size(), self.encoder.get_reshape_size(), hidden_dim, latent_dim, device)
    self.encoder = PretrainedEncoder(input_dim, hidden_dim, 2*latent_dim, device)
