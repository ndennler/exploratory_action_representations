    ...
    def __getitem__(self, item):
        ...
        if self.is_train:
            if self.kind in ['auditory', 'visual']:
                ...
                anchor = self.stimulus_array[self.get_stimulus_fname(int(anchor)), :]
                positive  = self.stimulus_array[self.get_stimulus_fname(int(positive)), :]
                negative = self.stimulus_array[self.get_stimulus_fname(int(negative)), :]
